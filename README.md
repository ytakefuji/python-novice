# python-novice
<pre>
The goal of "python-novice" is for novice to learn the basic csv file manipulations (read, write, update, columns operations) and to practice basic supervised machine learning including classification and regression. Integer, floating point, string, list operations are introduced. Data preprocessing, and data augmentation are addressed. Graph plotting is also described using matplotlib.
